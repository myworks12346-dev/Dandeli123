  ...
  return (
    <section id="contact-us" className="py-10 sm:py-20 px-3.5 sm:px-6 lg:px-8 max-w-7xl mx-auto transition-colors duration-300">
      ...
      <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-14">
        <div className={`text-[11px] sm:text-xs font-semibold tracking-wider uppercase mb-2 inline-flex items-center gap-1.5 px-3 py-1 rounded-full ${
          isLight ? 'bg-[#f0e7d8] text-[#9c7d49]' : 'bg-[#221c15] text-[#d4aa73]'
        }`}>
          <Sparkles className="w-3.5 h-3.5" />
          <span>Dandeli Travel & Booking Desk</span>
        </div>
